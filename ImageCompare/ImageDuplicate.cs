...
namespace ImageCompare
{
    ...
    internal struct ImageDuplicate : IComparable<ImageDuplicate>
    {
        /// <summary>
        ...
        /// </returns>
        public readonly bool Equals(ImageDuplicate other)
        {
        ...
        /// </returns>
        public readonly int CompareTo(ImageDuplicate other)
        {
            if (Image == null)
            {
                return 0;
